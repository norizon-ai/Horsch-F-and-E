...
module deepgramService 'modules/container-app.bicep' = {
  ...
  params: {
    ...
    envVars: [
      ...
      { name: 'UPLOAD_DIR', value: '/app/data' }
...
module workflowService 'modules/container-app.bicep' = {
  ...
  params: {
    ...
    envVars: [
      { name: 'DATABASE_URL', value: 'postgresql+asyncpg://pgadmin:NorizonTemp123!@psql-norizon-internal-xxvvxr3ldwrum.postgres.database.azure.com:5432/workflows' }
      ...
      { name: 'WORKFLOW_CORS_ORIGINS', value: 'https://internal.norizon.de,https://frontend.${env.outputs.defaultDomain}' }
