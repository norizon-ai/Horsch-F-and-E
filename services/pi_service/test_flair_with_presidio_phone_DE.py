#!/usr/bin/env python3
"""
Test Flair Model with Presidio Phone Recognizer for German Text
==============================================================

This test demonstrates how the PII de-identification system works 
using the German Flair model and Presidio's built-in phone recognizer.

It uses the existing system architecture:
- Configuration from user_configs/pipelines/flair_with_presidio_phone_pipeline.json
...
- Presidio's sophisticated phone number detection
...
def process_with_flair_and_presidio_phone(pipeline, text):
    """Process text using both Flair and Presidio phone recognizers from the pipeline."""
    try:
        ...
        print(f"Error in Flair and Presidio phone pipeline processing: {e}")
        return None, []
...
def print_banner():
    ...
    print("=" * 70)
    print("🔒 GERMAN FLAIR + PRESIDIO PHONE - PII DE-IDENTIFICATION SERVICE")
    print("=" * 70)
    print("Demonstrates German language PII detection using Flair model + Presidio phone")
    print("Built with modular architecture for maximum flexibility")
    print("=" * 70)


def build_and_run_pipeline(config_path):
    """Build and run the Flair + Presidio phone recognizer pipeline."""
    print("\n🚀 BUILDING AND RUNNING FLAIR + PRESIDIO PHONE PIPELINE")
    print("-" * 50)
    ...
    try:
        ...
        print("✅ Flair + Presidio phone pipeline built successfully")
...
def process_german_sample_data(pipeline):
    """Process German sample data with the Flair + Presidio phone pipeline."""
    ...
    try:
        ...
        sample_texts = [
            ...
            "Für weitere Informationen kontaktieren Sie uns unter 0176-123-4567 oder +49-89-987-6543. Unser Büro befindet sich in Hamburg."
        ]
        ...
        for i, text in enumerate(sample_texts, 1):
            ...
            # Process using the Flair + Presidio phone pipeline
            anonymized_text, entities = process_with_flair_and_presidio_phone(pipeline, text)
...
def demonstrate_combined_capabilities():
    """Demonstrate the capabilities of the combined Flair + Presidio phone recognizers."""
    ...
    print("\n✅ Phone Numbers (PHONE_NUMBER) - Presidio's Built-in:")
    ...
    print("\n🔍 Enhanced Detection with Presidio:")
    print("  • Flair model provides high-accuracy NER for German text")
    print("  • Presidio's built-in phone recognizer uses advanced NLP")
    print("  • Better international phone number support")
    print("  • Context-aware phone number detection")
    print("  • Regular updates and improvements from Microsoft")


def main():
    """Main function to run the German Flair + Presidio phone interface."""
    print_banner()
    
    # Build Flair + Presidio phone pipeline
    ...
    print("\n" + "=" * 70)
    print("🎉 GERMAN FLAIR + PRESIDIO PHONE DEMO COMPLETE!")
    print("=" * 70)
    print("✅ German Flair model working correctly")
    print("✅ Presidio phone recognizer working correctly")
    print("✅ Combined PII detection successful")
    print("✅ Enhanced phone number detection with Presidio")
    print("✅ Anonymization with German text working")
    print("✅ Ready for German language processing with advanced phone detection")
    print("=" * 70)
